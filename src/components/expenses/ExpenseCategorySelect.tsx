      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="w-full rounded-lg border border-brand-blue-500 bg-surface px-4 py-3.5 text-sm text-ink-900 shadow-card focus:border-brand-blue-500"
          />
          <button
            type="button"
          ...
          <button
            ...
            className="shrink-0 rounded-lg border border-ink-100 bg-surface px-4 py-3.5 text-sm text-ink-700 hover:bg-surface-2"
          >
            Cancel
          </button>
        </div>
  ...
  return (
    <div>
      ...
      <select
        ...
        className={`w-full rounded-lg border bg-surface px-4 py-3.5 text-sm text-ink-900 shadow-card focus:border-brand-blue-500 ${
