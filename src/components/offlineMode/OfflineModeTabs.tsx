...
const TABS = [
  { to: '/offline-mode', label: 'Status', exact: true },
  { to: '/offline-mode/queue', label: 'Pending Sync' },
  { to: '/offline-mode/conflicts', label: 'Conflicts' },
  { to: '/offline-mode/history', label: 'Sync History' },
  { to: '/offline-mode/settings', label: 'Settings' },
]

export function OfflineModeTabs() {
