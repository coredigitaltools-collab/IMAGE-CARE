  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          id={fieldId}
          className={`w-full rounded-md border bg-white px-3 py-2 text-sm text-ink-900 shadow-card transition-colors placeholder:text-ink-300 focus:border-brand-blue-500 ${
