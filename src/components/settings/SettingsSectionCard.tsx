...
export function SettingsSectionCard({ to, icon: Icon, title, description }: SettingsSectionCardProps) {
  return (
    ...
    >
      ...
      >
        <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-brand-blue-50 text-accent transition-all duration-[250ms] ease-out group-hover:scale-105 group-hover:bg-brand-blue-700 group-hover:text-white">
        ...
        <ChevronRight
          size={16}
          className="mt-1 shrink-0 text-ink-300 transition-all duration-[250ms] ease-out group-hover:translate-x-1 group-hover:text-accent"
          aria-hidden="true"
        />
      </Card>
    </Link>
